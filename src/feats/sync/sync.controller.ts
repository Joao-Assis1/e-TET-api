...
export class SyncController {
  ...
  @Get('initial')
  @ApiOperation({ summary: 'Baixar base de dados inicial para o tablet (Offline-First)' })
  ...
  @Post('batch')
  @ApiOperation({ summary: 'Sincronizar Lote (Batch) de Domicílios, Famílias, Indivíduos e Visitas do tablet para a API (Calcula Risco Coelho-Savassi)' })
